...
export function ConfirmModal() {
  ...
  return (
    <dialog ref={ref} className="confirm" aria-labelledby="confirm-title" onCancel={(e) => { e.preventDefault(); resolveConfirm(false); }}>
      ...
      <p>{q ? <>Your work on <strong>{q.placeName}</strong> goes to a person who checks it before it is used.</> : 'A person will check your answer before it is used.'} You can edit it again if it is sent back.</p>
